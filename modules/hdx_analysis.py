# NMR hydrogen-deuterium exchange analysis tools
...
def analysis_scheme(peak_heights_files=None):
    """Example workflow. Runs as main if this file is used as a script.
    ...
    if peak_heights_files is None:
        peak_heights_files = \
            [i for i in listdir(getcwd()) if i.endswith('hdx_peak_heights')]
    t0_list = ['2013-01-31_17:40', '2012-11-28_15:16', '2012-11-28_15:16']
